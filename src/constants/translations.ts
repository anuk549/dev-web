/**
 * Translations for the Dev+ Quote Builder application
 * Supports English (en) and Sinhala (si)
 */
...
export const translations = {
  en: {
    ...
    topicPlaceholder:
      "Briefly describe the project topic, deadline, and special requirements.",
    ...
    whatsappNotConfigured:
      "WhatsApp number is not configured. Set NEXT_PUBLIC_DEV_WHATSAPP_NUMBER and redeploy.",
    // Summary drawer
  ...
  si: {
    ...
    welcomeDesc:
      "ඔබේ තාක්ෂණික කොටස, විශේෂාංග, පිටු, දත්ත සමුදා ආකෘති සහ බෙදාහැරීමේ විස්තර තෝරාගනිමින් පැහැදිලි මිල ගණන් ගොඩනගාගන්න. අනුමාන කිරීම් නැත, අපැහැදිලි ලිපි හුවමාරුවක් නැත.",
    ...
    feedbackDesc:
      "උපුටා දැක්වීමේ ගලා යාම ආරම්භ කිරීමට පෙර ආරම්භක පිටුව විශ්වසනීය බවක් දැනෙන පරිදි පෙන්වන නිදසුන් ව්‍යාපෘති ප්‍රතිපෝෂණ.",
    // Steps
    stepTitles: [
    ...
    topicPlaceholder:
      "ව්‍යාපෘති මාතෘකාව, කාලසීමාව සහ විශේෂ අවශ්‍යතා කෙටියෙන් විස්තර කරන්න.",
    ...
    // WhatsApp
    whatsappNotConfigured:
      "WhatsApp අංකය සැකසී නැත. NEXT_PUBLIC_DEV_WHATSAPP_NUMBER සකසා නැවත ස්ථාපනය කරන්න.",
    // Summary drawer
